    ...
    static func addPhysicsBody(to sprite: SKSpriteNode, with name: String) {
        switch name {
            case GameConstants.StringConstants.playerName:
                ...
                sprite.physicsBody?.collisionBitMask = GameConstants.PhysicsCategories.groundCategory | GameConstants.PhysicsCategories.finishCategory // percebe quando houver colisão com essas duas categorias (um ou outro)
